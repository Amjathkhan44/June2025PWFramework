...
export const test = base.extend<MyFixtures>({   //'test' is fixture name
    homePage: async ({ page, baseURL }, use, testInfo) => {
        ...
        await use(homePage);// use() is like returning a value from a fixture, but with setup and cleanup control.
