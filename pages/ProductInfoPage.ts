...
export class ProductInfoPage {
    ...
    /**
     * 
     * @returns this method is returning the complete product information: header, images count, meta data & pricing data
     */
    async getProductDetails(): Promise<Map<string, string | number | null>> {
        this.productMap.set('header', await this.getProductHeader());  //Creating my own keys 'header' and 'imagecount'
